...
public class RestServices extends Global {
	...
	public Response postMethod(String baseURI, String resourcePath, String contentType, String userName,
			String password, String token, String inputPayload) {
	...
	@Test
	public Response postMethodFile(String baseURI, String resourcePath, String contentType, String filePath,
		...
		httpRequest.multiPart("file", new File(filePath));
		//httpRequest.auth().basic(userName, password);
		//httpRequest.auth().preemptive().basic(userName, password);
		httpRequest.body(inputPayload);
		// Response
	...
	@Test
	public Response postMethodformData(String baseURI, String resourcePath, String contentType, String data1,
			String name1, String data2, String name2) {
		logger.info("Entered in to postMethod method.");
		// BaseURL
		RestAssured.baseURI = baseURI;
		// Request
		...
		httpRequest.contentType(contentType);
		httpRequest.contentType("multipart/form-data");
		httpRequest.multiPart("name", name1);
		httpRequest.multiPart("status", name2);
		//httpRequest.auth().basic(userName, password);
		//httpRequest.auth().preemptive().basic(userName, password);
//		httpRequest.body(inputPayload);
		// Response
	...
	public Response putMethod(String baseURI, String resourcePath, String contentType, String userName,
			String password, String inputPayload, String token) {
	...
	@Test
	public Response patchMethod(String baseURI, String resourcePath, String contentType, String userName,
			String password, String inputPayload) {
		
		
		logger.info("Entered in to patchMethod method.");
		// BaseURL
		RestAssured.baseURI = baseURI;
		// Request
		RequestSpecification httpRequest = RestAssured.given().relaxedHTTPSValidation();
		...
		Response response = httpRequest.put(resourcePath);
		getStatusLine(response);
		logger.info("Exit from patchMethod method.");
		return response;
	}
