...
public class GetComp extends Global {
	...
	public GetComp() throws FileNotFoundException, IOException, ParseException {
...
//					resourcePath = resourcePath+"?key="+inputPayloadElementsMap.get("payload_key")+"&place_id="+inputPayloadElementsMap.get("payload_place_id");
					...
					resourcePath = resourcePath+"/"+inputPayloadElementsMap.get("payload_id");
