...
public class GetBook extends Global {
	...
	public GetBook() throws FileNotFoundException, IOException, ParseException {
...
//					resourcePath = resourcePath+"?key="+inputPayloadElementsMap.get("payload_key")+"&place_id="+inputPayloadElementsMap.get("payload_place_id");
					...
					resourcePath = resourcePath+"?ID="+inputPayloadElementsMap.get("payload_id");
...
//			        Gson gson = new Gson();
//			        Gson gson = new Gson();
//			        String jsonArray = gson.toJson(resp);
//			        JsonObject jo = new JsonObject(resp);
//			        //read JSON to a java HashMap
//					Reader reader = new InputStreamReader(content);
//			        GsonBuilder gsonBuilder = new GsonBuilder();
//	                Gson gson = gsonBuilder.create();
//			        List<Post> postsList = Arrays.asList(gson.fromJson(resp,Post[].class));
//			        HashMap<String, Object> mapRes = gson.fromJson(resp, HashMap.class);  
//			        System.out.println( mapRes);
					
					Gson gson = new Gson();    
					JsonArray array = gson.fromJson(resp, JsonArray.class);    
					System.out.println(array);
//					for(JsonElement element : array) {      
//					JsonArray array1 = gson.fromJson(element, JsonArray.class);
//					System.out.println(array1);
//					}
//					System.out.println(CommonUtilities.jsonTOMap(resp).get("author"));
//					HashMap<String, Object> res = CommonUtilities.jsonTOMap(resp);
