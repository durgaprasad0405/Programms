...
public class PostEmp extends Global {
	...
	public PostEmp() throws FileNotFoundException, IOException, ParseException {
...
//					resourcePath = resourcePath + "?key=" + inputPayloadElementsMap.get("payload_key");
					...
					response = restServices.postMethod(baseURI, resourcePath, contentType, token, password,
							token,inputPayload);
					...
					idd = jsonResultMap.get("id").toString();
					String id = idd.substring(0,7);
