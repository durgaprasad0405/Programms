...
public class GetPetByStatus extends Global {
	...
	public GetPetByStatus() throws FileNotFoundException, IOException, ParseException {
...
//					resourcePath = resourcePath+"?key="+inputPayloadElementsMap.get("payload_key")+"&place_id="+inputPayloadElementsMap.get("payload_place_id");
					...
					resourcePath = resourcePath+"?status="+inputPayloadElementsMap.get("payload_status");
