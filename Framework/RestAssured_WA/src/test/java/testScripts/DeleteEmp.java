...
public class DeleteEmp extends Global {
	...
	public DeleteEmp() throws FileNotFoundException, IOException, ParseException {
...
//					resourcePath = resourcePath+"?key="+inputPayloadElementsMap.get("payload_key")+"&place_id="+inputPayloadElementsMap.get("payload_place_id");
					...
					String token = inputPayloadElementsMap.get("payload_token");
