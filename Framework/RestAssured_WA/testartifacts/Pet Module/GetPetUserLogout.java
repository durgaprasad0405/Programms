...
public class GetPetUserLogout extends Global {
	...
	public GetPetUserLogout() throws FileNotFoundException, IOException, ParseException {
...
//					resourcePath = resourcePath+"?username="+inputPayloadElementsMap.get("payload_username")+"&password="+inputPayloadElementsMap.get("payload_password");
					
//					resourcePath = resourcePath+"/"+inputPayloadElementsMap.get("payload_username");
...
//			        HashMap<String, Object> res = gson.fromJson(resp, HashMap.class); 
//			        System.out.println(res);
//			        System.out.println( res.get("data.year"));
//			        System.out.println(res.get("name"));
