...
public class PostPetUser extends Global {
	...
	public PostPetUser() throws FileNotFoundException, IOException, ParseException {
...
//					resourcePath = resourcePath + "?key=" + inputPayloadElementsMap.get("payload_key");
					...
					id = jsonResultMap.get("message").toString();
